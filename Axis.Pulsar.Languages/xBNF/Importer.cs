...
namespace Axis.Pulsar.Languages.xBNF
{
    ...
    public class Importer : IImporter, ICustomTerminalRegistry, IValidatorRegistry
    {
        ...
        #region Pre-registered custom terminals
        public const string CUSTOM_TERMINAL_DQD_STRING = "DQD-String";
        public const string CUSTOM_TERMINAL_SQD_STRING = "SQD-String";
        #endregion

        private static readonly PulsarGrammar xBnfGrammar;

        private readonly ConcurrentDictionary<string, IProductionValidator> _validatorMap = new();
        private readonly ConcurrentDictionary<string, ICustomTerminal> _customTerminals = new();
        ...
        public Importer()
        {
            ...
            this._customTerminals[CUSTOM_TERMINAL_DQD_STRING] = new DelimitedString(
                CUSTOM_TERMINAL_DQD_STRING,
                "\"",
                new DelimitedString.BSolGeneralEscapeMatcher());

            // Add Single-quote-delimited-string custom terminal with key 'SQD-String'
            this._customTerminals[CUSTOM_TERMINAL_SQD_STRING] = new DelimitedString(
                CUSTOM_TERMINAL_SQD_STRING,
                "\'",
                new DelimitedString.BSolGeneralEscapeMatcher());
        }
