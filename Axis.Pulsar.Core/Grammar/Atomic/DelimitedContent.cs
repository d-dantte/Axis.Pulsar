...
namespace Axis.Pulsar.Core.Grammar.Atomic
{
    ...
    public class DelimitedContent : IAtomicRule
    {
        ...
        public readonly struct DelimiterInfo: IDefaultValueProvider<DelimiterInfo>
        {
            ...
            /// <summary>
            /// Finds the index of the next occurence of the <see cref="DelimiterInfo.Delimiter"/>, assigning it to
            ...
            /// <returns>True if no <see cref="DelimiterInfo.EscapeSequence"/> exist, or if the found delimiter isn't a subset of the escape sequence.</returns>
        ...
        public class LiteralPattern : IPattern
        {
            ...
            public LiteralPattern(string literal, bool isCaseSensitive = true)
            {
                ...
                this.comparison = isCaseSensitive switch
                {
